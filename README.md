...
|             Главный экран (темная тема)             |               Описание фильма (темная тема)                |         Избранное (темная тема)          |
|:---------------------------------------------------:|:----------------------------------------------------------:|:----------------------------------------:|
| <img src="screenshots/Dark_main.png" width="250"> | <img src="screenshots/Dark_description.png" width="250"> | <img src="screenshots/Dark_Favorites.png" width="250"> |
