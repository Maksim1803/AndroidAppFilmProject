...
class HomeFragment : Fragment() {
    ...
    private val filmsDataBase = listOf(
        ...
        Film(
            "Хищник",
            R.drawable.hishnik,
            "Американский вертолет был сбит партизанами в Южной Америке, " +
                    "оставшийся в живых экипаж попал в плен. ЦРУ бросает лучшие силы для " +
                    "освобождения американских граждан — элитная группа спецназа во главе с " +
                    "Датчем отправляется в южноамериканские джунгли. Но там немало повидавшим " +
                    "бойцам предстоит встретиться с невероятным ужасом.."
        ),
        Film(
            "Топган",
            R.drawable.topgun,
